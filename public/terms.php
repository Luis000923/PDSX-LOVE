...
$sections = [
    ...
    'html-propio' => ['HTML propio y fotos de los usuarios', "
        ...
        <ul>
          ...
          <li>Si tú así lo consideras, puedes decidir <strong>publicarlas después en la Galería</strong> para que otros usuarios las usen. La publicación <strong>nunca es automática</strong>: solo ocurre con tu solicitud o autorización expresa (con el botón «Publicar en la Galería» de cada página de HTML propio en «Mis páginas», o desde «Subir mi plantilla» eligiendo la opción pública). Para publicarla, LovePages podrá revisarla y <strong>adaptarla o modificarla</strong> (por ejemplo, ajustar el diseño móvil, sustituir datos personales por campos editables o corregir problemas de seguridad), y podrá rechazarla si no cumple las reglas.</li>
